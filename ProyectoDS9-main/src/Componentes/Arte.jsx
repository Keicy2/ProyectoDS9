...
const Arte = ({children}) => {
  ...
  const products = [
    ...
    { id: 412, name: 'BARNIZ DURAC MATE', description: '50ml mate', price: 3.00, image: 'utiles/Barniz Durac Mate 3.00.png' },
    { id: 512, name: 'BARNIZ DURAC SATINADO', description: '50ml Satinado', price: 3.00, image: 'utiles/Barniz Durac Satinado 3.00.png' },
